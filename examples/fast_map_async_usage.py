...
#########################################################
#  Example 1 (when we are interested in return values)
#########################################################
...
#########################################################
#  Example 2 (when we don't care about return values)
#########################################################

# function that prints instead of returning
# it isn't guaranteed that printed values will be in order
def task2(x):
    time.sleep(1)
    print(x*x)

print(('This time the order of printed numbers will differ. '
       'That\'s because only returned values are ordered. '
       'The order of executed tasks is not preserved.\n'))
